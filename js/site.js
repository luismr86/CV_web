                ...
                if (rsFormCaptcha === true) {
                    ...
                    $.post( rsFormAction,
                        ...
                        function (response) {
                            ...
                            if(data){
                                rsForm.append('<div class="rsFormResponce"><strong>¡E-mail enviado!</strong><br>Luis te responderá en la mayor brevedad posible</div>');
                            } else {
                                rsForm.append('<div class="rsFormResponce"><strong>OOPS!</strong> Algo no fue bien.<br>Por favor, inténtalo de nuevo</div>');
                            }
                        }
                    );
                    return false;
